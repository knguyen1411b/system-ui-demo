        ...
        <div className="min-h-screen bg-[#0f172a] p-4 sm:p-8 lg:p-10 text-slate-200 font-['Plus_Jakarta_Sans',sans-serif] relative overflow-hidden">
            ...
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                ...
                <div className="border-l-4 border-[#8b5cf6] pl-4 text-left sm:text-right">
                    <span className="block text-xl font-bold font-mono text-orange-400 tracking-wider">
                        {currentTime}
                    </span>
            ...
            <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-5 mb-[25px] flex flex-col sm:flex-row gap-[15px]">
                ...
                >
                    <option value="Tất cả" className="bg-[#1e1b4b]">
                        Trạng thái: Tất cả
                    </option>
                    <option value="Chờ tiếp nhận" className="bg-[#1e1b4b]">
                        Chờ tiếp nhận
                    </option>
                    <option value="Đang xử lý" className="bg-[#1e1b4b]">
                        Đang xử lý
                    </option>
                    <option value="Đã hoàn thành" className="bg-[#1e1b4b]">
                        Đã hoàn thành
                    </option>
                </select>
            </div>
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-white/[0.05] border-b border-white/10">
                                <th className="px-6 py-4 text-left text-xs font-bold text-[#c4b5fd] uppercase tracking-wider">
                                    Phòng
                                </th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-[#c4b5fd] uppercase tracking-wider max-w-[400px]">
                                    Nội dung báo hỏng
                                </th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-[#c4b5fd] uppercase tracking-wider">
                                    Thời gian yêu cầu
                                ...
                                <th className="px-6 py-4 text-center text-xs font-bold text-[#c4b5fd] uppercase tracking-wider">
                                    Hành động
                                </th>
                            </tr>
                        </thead>
                                ...
                                filteredIncidents.map(item => (
                                    <tr key={item.id} className="hover:bg-white/[0.02] transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="text-[#fb923c] font-extrabold text-base tracking-wide">
                                                {item.room}
                                            </span>
                                        </td>
                                    ...
                                    <td colSpan="5" className="px-6 py-12 text-center text-sm text-[#94a3b8]">
                                        <div className="flex flex-col items-center justify-center gap-2">
                                            <span className="text-base">
                                                Không tìm thấy dữ liệu báo hỏng nào phù hợp.
                                            </span>
                                        </div>
                                    </td>
                                </tr>
