    ...
    const submit = e => {
        ...
        if (editingId) {
            setRows(
                rows.map(item =>
                    item.id === editingId
                        ? { ...form, id: editingId, price: Number(form.price), stock: Number(form.stock) }
                        : item
                )
            )
            setEditingId(null)
        ...
        <div className="bg-[#0f172a] text-slate-200 p-8 space-y-8">
            ...
            <header className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 font-medium">
                        Quản lý danh sách, giá cả và số lượng tồn kho của kho thực phẩm
                    </p>
                </div>
            </header>
            ...
            >
                ...
                <div className="flex flex-col gap-1">
                    ...
                    >
                        <option value="drink" className="text-slate-900">
                            Đồ uống
                        </option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                    <option value="all" className="text-slate-900">
                        Tất cả trạng thái kho
                    </option>
                    <option value="low" className="text-slate-900">
                        Sắp hết hàng (Dưới 10)
                    </option>
                    <option value="instock" className="text-slate-900">
                        Còn hàng dồi dào
                    </option>
                </select>
            </div>
                    ...
                    >
                        ...
                        <div className="h-40 overflow-hidden relative bg-slate-800 flex items-center justify-center">
                            <img
                                ...
                                onError={e => {
                                    e.target.src = 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=400'
                                }}
                            />
                            <span
                                className={`absolute top-3 right-3 text-[10px] font-extrabold uppercase px-2.5 py-1 rounded-lg tracking-wider ${
                                    s.type === 'drink'
                        ...
                        <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                            <div className="space-y-1">
                                <p className="text-[11px] text-purple-400 font-bold tracking-widest uppercase">
                                    {s.code}
                                </p>
                            ...
                            <div className="space-y-2">
                                <p className="text-lg font-black text-white">
                                    ...
                                    <span className="text-xs text-gray-400 font-normal">/ {s.unit}</span>
                                </p>
                                <div className="flex items-center gap-1.5">
                                    <span
                                        className={`w-2 h-2 rounded-full ${s.stock < 10 ? 'bg-rose-500 animate-pulse' : 'bg-emerald-500'}`}
                                    />
                                    <p
