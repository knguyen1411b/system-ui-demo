                            ...
                            {prices.map(item => (
                                <tr key={item.id} className="hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="px-4 py-4">
                                        <span
                                            className={`px-3 py-1 rounded-full text-[10px] font-bold border ${getDayTypeClass(item.dayType)}`}
                                        >
                                            {item.dayType}
                                        </span>
                                    </td>
                                    <td className="px-4 py-4">
                                        <span
                                            className={`px-2 py-1 rounded font-bold text-xs ${item.roomType === 'VIP' ? 'bg-yellow-400/10 text-yellow-400' : 'bg-purple-400/10 text-purple-400'}`}
                                        >
                                            {item.roomType}
                                        </span>
                                    </td>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            setSelectedPrice({ ...selectedPrice, to: parseFloat(e.target.value) || 0 })
                                        }
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 mt-1 outline-none focus:border-purple-500 text-white"
                                    />
                                </div>
