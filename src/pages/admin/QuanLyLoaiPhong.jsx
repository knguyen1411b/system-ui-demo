    ...
    const [roomTypes, setRoomTypes] = useState([
        {
            ...
            deposit: '200.000đ',
            description:
                'Phòng VIP với dàn âm thanh 7.1 cực đỉnh, hệ thống đèn laser theo nhạc và ghế massage cho khách chờ. Không gian sang trọng, riêng tư.',
        ...
        },
        {
            ...
            deposit: '100.000đ',
            description:
                'Phòng hát tiêu chuẩn, sạch sẽ, âm thanh trung thực. Phù hợp cho nhóm bạn sinh viên và gia đình.',
                ...
                {roomTypes.map(room => {
                    ...
                    return (
                        ...
                        >
                            {/* Card Header Top */}
                            <div
                                className={`flex flex-col items-center p-6 bg-gradient-to-br ${isVip ? 'from-yellow-400/10' : 'from-purple-400/10'} to-transparent`}
                            >
                                <span
                                    className={`text-2xl font-extrabold uppercase mb-2 ${isVip ? 'text-yellow-400' : 'text-purple-400'}`}
                                >
                                    {room.name}
                                </span>
                                ...
                                <span
                                    className={`inline-block font-bold rounded-xl px-4 py-2 text-xl mb-2 ${isVip ? 'bg-amber-400/20 text-amber-500' : 'bg-purple-400/20 text-purple-400'}`}
                                >
                                    Cọc: {room.deposit}
                                </span>
                            </div>
