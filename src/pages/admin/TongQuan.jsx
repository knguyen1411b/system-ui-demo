                        ...
                        {lowStockItems.length > 0 ? (
                            lowStockItems
                                ...
                                .map(item => (
                                    <div
                                        key={item.id}
                                        className="flex items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/5 hover:border-red-500/30 transition-all"
                                    >
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-0.5">
                                                    <span className="text-[10px] text-amber-500/80 font-medium">
                                                        {acc.points.toLocaleString()} điểm
                                                    </span>
