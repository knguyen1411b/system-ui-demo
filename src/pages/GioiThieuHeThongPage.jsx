        ...
        <div className="min-h-screen bg-gradient-to-br from-[#1e1b4b] to-[#0f172a] text-white">
            <div className="max-w-5xl mx-auto px-6 py-10">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                    <div>
                        <p className="text-xs uppercase tracking-[0.2em] text-purple-300 font-bold">Music Box</p>
                        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mt-1">Giới thiệu hệ thống</h1>
