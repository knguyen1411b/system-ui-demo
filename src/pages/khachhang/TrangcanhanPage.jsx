            ...
            <header className="bg-[#0f172a]/80 backdrop-blur-md sticky top-0 z-[100] border-b border-white/10">
                <div className="max-w-[1440px] mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-6 ml-8">
                        <a
                            href="/index.html"
                            className="text-sm font-bold text-white hover:text-[#a78bfa] transition-colors uppercase tracking-widest"
                        >
                            Trang chủ
                        </a>
                        <a
                            href="/phonghientai.html"
                            className="text-sm font-bold text-white hover:text-[#a78bfa] transition-colors uppercase tracking-widest"
                        >
                            Phòng hiện tại
                        </a>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <button
                                    ...
                                    className="p-1 rounded hover:bg-[#8b5cf6]/20 transition"
                                    title="Sửa thông tin"
                                >
                                    <svg
                ...
                {showEdit && (
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                        ...
                        <form
                            ...
                            className="[animation:modalScale_0.3s_ease-out_forwards] [box-shadow:0_0_25px_rgba(139,92,246,0.2),_inset_0_0_1px_rgba(255,255,255,0.2)] w-full max-w-sm rounded-[2rem] overflow-hidden relative z-10 border border-white/20 bg-[#161b33]/90 shadow-2xl"
                        >
                            <div className="px-6 py-5 border-b border-white/10 flex justify-between items-center bg-gradient-to-r from-[#8b5cf6]/20 to-transparent">
                                <div>
                                    <h4 className="font-extrabold text-white text-lg tracking-tight uppercase">
                                        Sửa thông tin
                                    </h4>
                                    <p className="text-[10px] text-[#a78bfa] font-bold tracking-[0.2em]">
                                        CẬP NHẬT TÀI KHOẢN
                                    </p>
                                </div>
                                <button
                                    type="button"
                                    onClick={() => setShowEdit(false)}
                                    className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 text-gray-400 hover:text-white hover:bg-rose-500/20 transition-all duration-300"
                                >
                            ...
                            <div className="p-6 flex flex-col gap-5">
                                <div className="space-y-2 group">
                                    <label className="text-[11px] font-black text-[#a78bfa] uppercase ml-1 tracking-wider">
                                        Họ và Tên
                                    </label>
                                ...
                                <div className="space-y-2 opacity-60">
                                    <label className="text-[11px] font-black text-gray-400 uppercase ml-1 tracking-wider">
                            ...
                            <div className="p-6 pt-2 flex gap-3">
                                <button
                                    type="button"
                                    onClick={() => setShowEdit(false)}
                                    className="flex-1 py-3 rounded-2xl bg-white/5 hover:bg-white/10 text-white font-bold text-xs uppercase tracking-widest transition-all duration-300"
                                >
                                    Hủy
                                </button>
                                <button
                                    type="submit"
                                    className="flex-[2] py-3 rounded-2xl bg-gradient-to-r from-[#7c3aed] to-[#8b5cf6] hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] text-white font-bold text-xs uppercase tracking-[0.2em] transition-all duration-300 active:scale-95"
                                >
                                    Lưu thay đổi
                                </button>
                            </div>
